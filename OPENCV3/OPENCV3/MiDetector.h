...
//
//		const char *cascade_name =   (char*)Marshal::StringToHGlobalAnsi(System::IO::Directory::GetCurrentDirectory()+"\\haarcascade_frontalface_default.xml").ToPointer()   ;
//		CvHaarClassifierCascade *cascade = 0;
//		CvMemStorage *storage = 0;
//		CvSeq *faces;
//		cascade = (CvHaarClassifierCascade *) cvLoad (cascade_name, 0, 0, 0);
//
//		src_gray = cvCreateImage (cvGetSize(mat), IPL_DEPTH_8U, 1);
